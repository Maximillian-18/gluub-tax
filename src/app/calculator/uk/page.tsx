  ...
  return (
    <div className="min-h-screen bg-[#0d2818] text-[#2ecc71] flex flex-col">
      <main className="flex-1 flex flex-col items-center px-4 md:px-8 py-8 md:py-12 pt-20 md:pt-24 gap-8 md:gap-12">
        ...
        <div className="w-full max-w-2xl">
          ...
          <div className="space-y-6">
              ...
              <div className="flex flex-col sm:flex-row gap-4 items-start sm:items-center">
                <Tabs value={pensionType} onValueChange={(v) => setPensionType(v as "percentage" | "amount")} className="w-auto">
                  <TabsList className="bg-transparent border border-[#2ecc71]">
                    <TabsTrigger 
                      value="percentage" 
                      className="px-3 md:px-4 py-2 text-sm md:text-base text-[#2ecc71] data-[state=active]:bg-[#2ecc71] data-[state=active]:text-[#0d2818]"
                    >
                      Percentage
                    </TabsTrigger>
                    <TabsTrigger 
            ...
            <Button 
              ...
              disabled={loading}
              className="px-6 py-3 bg-[#f1c40f] text-[#0d2818] text-lg font-bold rounded-lg hover:bg-[#f39c12] transition-all duration-300 shadow-lg"
            >
        ...
        <div className="w-full max-w-2xl">
          {result && (
            <div className="bg-[#1a4d2e] rounded-xl p-6">
              ...
              {/* Net Pay */}
              <div className="bg-[#0d2818] rounded-lg p-4 space-y-2">
