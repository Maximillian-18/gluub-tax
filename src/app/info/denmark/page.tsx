      ...
      <section className="mb-12">
        <div className="bg-[#020806] border border-[#2ecc71]/30 rounded-lg p-8 text-center">
          <p className="text-lg text-[#2ecc71]/80">
            We're currently working on a comprehensive guide to Danish income tax, including municipal tax (kommuneskat), ATP pension, and labour market contributions.
          </p>
        </div>
      </section>
    </article>
